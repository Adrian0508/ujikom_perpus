              ...
              <div class="col-lg-8 offset-lg-2">
                <div class="kartu-kanan-profil">
                  <div class="judul-profil text-center">
                    ...
                    <p style="color: white;background-color: #4682B4;font-weight: 600;border-radius: 30px;padding: 0.5rem 1rem;">Halaman Profil</p>
                  </div>
                  <div class="gambar-user" style="width: 100px;height: 100px;border-radius: 50%;background-image:url('../assets/user.png');
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="isi-bio-user text-end" style="margin-top: 4rem;">
                        <a href="keluar.php" onclick="return confirmLogout();" style="text-decoration: none;color: white;font-weight: 500;padding: 0.5rem 1rem;border-radius: 30px;background-color: red;">Keluar Akun</a>
                      </div>
                    </div>
                  </div>
                </div>
