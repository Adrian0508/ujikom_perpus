        ...
        <div class="col-lg-7 pb-4">
            ...
            <div class="des-kanan d-flex gap-5">
                <p
                    ...
                    "
                >
                    <?php echo $detailBuku['NamaKategori']; ?>
                </p>
            ...
            <?php if($_SESSION['user'] === 'user') : ?>
                <div class="pinjam mt-4 d-flex">
                    ...
                    <?php else : ?>
                        <button style="background-color:#4682B4; color:white;" class="me-4 mb-4">Sudah Meminjam</button>
                    <?php endif; ?>
                    ...
                    <?php else : ?>
                        <button style="background-color:#00afdb; color:white;" class="me-4 mb-4">Sudah Memasukkan ke koleksi</button>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
