            ...
            <div class="col-lg-10 col-md-11 kanan-dasboard">
                ...
                <div class="container">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="tambah-buku.php" class="mt-3" style="border:none; padding: 7px; 20px; background-color:#4682B4; color:white; border-radius:5px; text-decoration:none;">Tambah Buku</a>
                    </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($data as $row) : ?>
                                <tr>
                                    ...
                                    <td data-label="Aksi">
                                        <a class="me-1" href="javascript:void(0);" onclick="confirmDelete(<?= $row['BukuID'] ?>)"><i class="fa-solid fa-trash" style="color:red;"></i></a>
    ...
    <script>
        ...
        function confirmDelete(bukuID) {
            if (confirm("Apakah Anda yakin ingin menghapus buku ini?")) {
                window.location.href = "list-buku-admin.php?hapus=" + bukuID;
            } else {
