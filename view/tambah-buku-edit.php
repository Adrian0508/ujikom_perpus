                  ...
                  <div class="kartu-kanan-profil" style="height: 540px; overflow-y: scroll">
                    ...
                    <div class="row mt-5">
                      ...
                      <div class="col-lg-7">
                        ...
                        <div class="bungkus-input">
                          <p style="font-weight: 700; font-size: 1.2rem" class="mt-3">
                            Penulis
                          </p>
                          <div class="kanan-input" style="
                                padding: 0.5rem 1rem;
                        ...
                        <div class="bungkus-input mt-4">
                          ...
                          <div class="bungkus-pilih d-flex" style="gap: 1rem">
                            <div class="pilih">
                              <input type="radio" id="jenis1" name="kategori" <?php if ($ambilBuku['KategoriID'] === "1") : ?> checked <?php endif; ?> value="1">
                              <label for="jenis1">Pendidikan</label><br>
                              <input type="radio" id="jenis2" name="kategori" <?php if ($ambilBuku['KategoriID'] === "2") : ?> checked <?php endif; ?> value="2">
                              <label for="jenis2">Komik</label><br>
                              <input type="radio" id="jenis3" name="kategori" <?php if ($ambilBuku['KategoriID'] === "3") : ?> checked <?php endif; ?> value="3">
                              <label for="jenis3">Novel</label><br>
                            </div>
                          </div>
                          <button type="submit" name="edit" class="mt-3" style="border:none; padding: 7px; 20px; background-color:#4682B4; color:white; border-radius:10px;">Tambah Buku</button>
                        </div>
                      </div>
                    </div>
                  </div>
