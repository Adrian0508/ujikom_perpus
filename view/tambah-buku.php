    ...
    <div class="section-list">
      <div class="row">
        <div
          ...
          style="background-color: #4682B4; height: 100vh"
        >
          <img
                      ...
                      <div class="row mt-5">
                        ...
                        <div class="col-lg-7">
                          ...
                          <div class="bungkus-input mt-4">
                            ...
                            <button type="submit" name="tambah" class="mt-3" style="border:none; padding: 7px; 20px; background-color:#4682B4; color:white; border-radius:10px;">Tambah Buku</button>
                          </div>
                        </div>
                      </div>
                    </div>
